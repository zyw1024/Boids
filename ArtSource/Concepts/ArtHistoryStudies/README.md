...
**当前范围：制作 E「彩色梦境」的单场景风格样片，镜头完全固定，本版只验证美术风格；Boids、投喂与海域切换留到后续，F 保留为后续美术参考。** 图片由内置 image_gen 工具生成，属于美术方向参考，不是 Unity 实机截图；模型、Shader 与场景尚未据此实施。完整提示词见 [PROMPTS.md](PROMPTS.md)。
...
上述样片尚未开始制作。投喂深度、鱼群规模与互动规则留到玩法阶段讨论；具体 Shader 做法由后续实机试验验证。
