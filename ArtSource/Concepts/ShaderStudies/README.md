...
**本目录保留第一轮材质方向探索；当前已确定制作 E 的单场景风格样片，镜头完全固定，本版只看风格，见[第二轮场景方向](../ArtHistoryStudies/README.md)。** Boids、投喂与海域切换留到后续，F 保留为后续参考。图片由内置图像生成工具生成，属于美术目标，不代表已经实现的 Unity Shader 或实机效果。
