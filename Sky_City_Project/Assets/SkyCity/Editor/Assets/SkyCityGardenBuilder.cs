...
{
    public const string Root="Assets/SkyCity/Content/World/Botany";
    ...
    [MenuItem("Sky City/Assets/Build living gardens")]
    public static void Build()
    {
        ...
        var treeMat=new Material(Shader.Find("SkyCity/Living Botany")){name="Wind tree - sage and silver"};treeMat.SetFloat("_Tree",1);treeMat=Save(treeMat,"Wind tree.mat");
        var flowerMat=Save(new Material(Shader.Find("SkyCity/Living Botany")){name="Living lavender and ivory"},"Living flowers.mat");
        ...
        planter.GetComponent<Renderer>().sharedMaterial=AssetDatabase.LoadAssetAtPath<Material>("Assets/SkyCity/Content/Island/Warm carved limestone.mat");
        ...
        earth.GetComponent<Renderer>().sharedMaterial=AssetDatabase.LoadAssetAtPath<Material>("Assets/SkyCity/Content/Island/Garden beds.mat");Object.DestroyImmediate(earth.GetComponent<Collider>());
    ...
    [MenuItem("Sky City/Assets/Install streamed gardens")]
