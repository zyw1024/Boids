...
{
    public const string FieldPath=SkyCityAssetPaths.Island+"/SculptedCloudField.asset";
    ...
    [MenuItem("Sky City/Assets/Sculpt cloud sea")]
    public static void Bake()
    {
        ...
        var compute=AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/SkyCity/Shaders/SkyCityHeroCloudBake.compute");
        var noise=AssetDatabase.LoadAssetAtPath<Texture3D>(SkyCityAssetPaths.Shared+"/PerlinWorleyVolume.asset");
        ...
        try
        {
            ...
            var material=AssetDatabase.LoadAssetAtPath<Material>(SkyCityAssetPaths.Island+"/Rolling sunlit cloud banks.mat");
