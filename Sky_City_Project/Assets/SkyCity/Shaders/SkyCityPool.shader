Shader "SkyCity/Reflecting Garden Water"
{
    Properties
    {
        ...
        _MultipleElevations("Different garden elevations",Float)=0
        _OpticalDepth("Optical depth offset",Float)=0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(V i):SV_Target
            {
                ...
                if(_MultipleElevations>.5)flow=normalize(i.uv+float2(.0001,0));
