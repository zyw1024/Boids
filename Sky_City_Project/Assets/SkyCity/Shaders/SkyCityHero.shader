Shader "SkyCity/Hanging Gardens"
{
    Properties
    {
...
input.bakedGI=SampleSH(n);
        ...
        Pass
        {
            ...
            V metaVert(A a)
            {
                ...
                o.color=a.color;o.uv=a.uv;o.world=TransformObjectToWorld(a.positionOS.xyz);o.normal=TransformObjectToWorldNormal(a.normalOS);return o;
            }
